...
class DataParallelPPOActor(BasePPOActor):
    ...
    def update_policy(self, data: DataProto):
        ...
        if historical_objective and (self.moco_cagrad_shadow_enabled or self.config.use_kl_loss
            ...
            raise ValueError('Historical ToolRL mode supports symmetric-clip GDPO/DVAO without KL loss')
